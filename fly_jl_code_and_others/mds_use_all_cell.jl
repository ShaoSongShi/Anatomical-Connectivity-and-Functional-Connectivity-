...
# ====================== 配置路径 ======================
corr_matrix_path = "/home/user/ShenRuihong/bishe/corr_principal_validation/fly/Turner2021_connectome_connectivity/CouplingCorrelationMatrix_branson_weighted.csv"
cell_info_path = "/home/user/ShenRuihong/bishe/corr_principal_validation/fly/traced-neurons.csv"
sorted = 1
output_csv_path = "/home/user/ShenRuihong/bishe/corr_principal_validation/fly/Turner2021_connectome_connectivity/CouplingCorrelationMatrix_branson_weighted2.csv" # 新增输出路径
MAT_X_STRESS  = "/home/user/ShenRuihong/bishe/corr_principal_validation/fly/Turner2021_connectome_connectivity/CouplingCorrelationMatrix_branson_weighted.csv"
...
X = read(file, "X_classic")       # 降维后的坐标
stress = read(file, "stress_classic")  # 应力值
close(file)
# X = X'
